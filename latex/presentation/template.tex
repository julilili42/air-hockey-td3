...
\begin{frame}{Gameplay Examples}

\begin{columns}

\column{0.5\textwidth}
\centering
\textbf{vs. Weak Opponent}

\includegraphics[width=\linewidth]{assets/hockeyenv1.png}

\vspace{0.2cm}
{\small File: gameplay\_weak.mov}

\column{0.5\textwidth}
\centering
\textbf{vs. Strong Opponent}

\includegraphics[width=\linewidth]{assets/hockeyenv2.png}

\vspace{0.2cm}
{\small File: gameplay\_strong.mov}
